...
export default function ServiceCard({ service }) {
  ...
  return (
    <article className="text-center p-8 group">
      <div className="text-primary/70 mb-4 flex justify-center transition-colors duration-300 group-hover:text-primary">
        {icon}
      </div>
      <h3 className="font-serif text-lg text-stone-800 mb-2">{service.name}</h3>
